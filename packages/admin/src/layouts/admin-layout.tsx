...
const navItems = [
  ...
  { label: 'AI Search', href: '/admin/plugins/ai-search', icon: Search },
  { label: 'Stripe', href: '/admin/plugins/stripe', icon: CreditCard },
  { label: 'Security Audit', href: '/admin/plugins/security-audit', icon: ShieldCheck },
  { label: 'Analytics', href: '/admin/plugins/analytics', icon: BarChart3 },
  { label: 'Workflow', href: '/admin/plugins/workflow', icon: GitBranch },
