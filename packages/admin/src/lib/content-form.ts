...
export function detailToContentFormValues(detail: ContentDetailResponse): ContentFormValues {
  return {
    title: detail.title,
    slug: detail.slug,
...
export function contentFormToCreateRequest(values: ContentFormValues): CreateContentRequest {
  return {
