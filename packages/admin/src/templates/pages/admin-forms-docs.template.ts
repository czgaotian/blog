      ...
      <main class="docs-content">
        ...
        <section id="overview" class="doc-section active">
          <div class="doc-header">
            <h2>📚 Overview</h2>
            <p>Complete reference for Worker Blog Forms powered by Form.io</p>
          </div>
          
          <div class="info-box">
            <strong>💡 New to Worker Blog Forms?</strong> Start with "Getting Started" in the sidebar, then explore the field types you need.
          </div>
