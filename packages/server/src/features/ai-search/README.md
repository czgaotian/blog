# AI Search Plugin for Worker Blog
...
The AI Search plugin is a core plugin and is included by default in Worker Blog.
...
- [Issue #362: Advanced search with Cloudflare Search](https://github.com/lane711/worker-blog/issues/362)
