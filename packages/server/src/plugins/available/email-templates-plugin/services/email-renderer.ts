...
import { renderTemplate } from '@worker-blog/shared/utils/template-renderer';
...
export class EmailTemplateRenderer {
  ...
  static getDummyVariables(): EmailVariables {
    return {
      ...
      // Content specific
      content: {
        title: 'Getting Started with Worker Blog',
        url: 'https://example.com/content/123',
        excerpt: 'Learn how to build amazing web applications with Worker Blog...',
      },
      ...
      replyToEmail: 'support@worker-blog-ai.com',
    };
  }
}
