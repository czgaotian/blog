...
vi.mock('@worker-blog/shared/utils/template-renderer', () => ({
...
describe('EmailTemplateRenderer', () => {
  ...
  describe('getSystemVariables', () => {
    it('should return system variables with current date and site info', () => {
      ...
      expect(systemVars.site).toHaveProperty('name', 'Worker Blog')
      expect(systemVars.site).toHaveProperty('url', 'https://worker-blog-ai.com')
