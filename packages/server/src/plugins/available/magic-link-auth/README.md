...
Passwordless authentication for Worker Blog via email magic links. Users sign in by clicking a secure one-time link sent to their email - no password required.
...
- ✅ **Email Integration**: Uses Worker Blog email plugin (Resend)
...
The plugin is included with Worker Blog but inactive by default.
