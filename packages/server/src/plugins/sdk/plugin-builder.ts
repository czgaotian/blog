 ...
 * Plugin Builder SDK
 *
 * Provides a fluent API for building Worker Blog plugins
 *
...
import { z } from 'zod'
import { Plugin, PluginBuilderOptions, PluginRoutes, PluginMiddleware, PluginModel, PluginService, PluginAdminPage, PluginComponent, PluginHook, PluginMenuItem } from '@worker-blog/shared/types'

/**
 * Fluent builder for creating Worker Blog plugins.
 *
 * @beta This API is in beta and may change in future releases.
 *
 * @example
 * ```typescript
 * import { PluginBuilder } from '@worker-blog/server'
 *
