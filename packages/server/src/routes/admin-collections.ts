...
import { renderCollectionsListPage } from '@worker-blog/admin/templates/pages/admin-collections-list.template'
import { renderCollectionFormPage } from '@worker-blog/admin/templates/pages/admin-collections-form.template'
