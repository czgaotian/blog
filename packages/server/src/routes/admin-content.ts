...
import { ContentVersion, renderVersionHistory, VersionHistoryData } from '@worker-blog/admin/templates/components/version-history.template'
import { ContentFormData, renderContentFormPage } from '@worker-blog/admin/templates/pages/admin-content-form.template'
import { ContentListPageData, renderContentListPage } from '@worker-blog/admin/templates/pages/admin-content-list.template'
import { getBlocksFieldConfig, parseBlocksValue } from '@worker-blog/shared/utils/blocks'
import { escapeHtml, sanitizeRichText } from '@worker-blog/shared/utils/sanitize'
  ...
  try {
    ...
    if (!collectionId) {
      ...
      const selectionHTML = `
        ...
        <html>
        <head>
          <title>Select Collection - Worker Blog Admin</title>
