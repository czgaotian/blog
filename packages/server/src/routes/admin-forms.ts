...
import { renderFormsListPage } from '@worker-blog/admin/templates/pages/admin-forms-list.template'
import { renderFormBuilderPage, type FormBuilderPageData } from '@worker-blog/admin/templates/pages/admin-forms-builder.template'
import { renderFormCreatePage } from '@worker-blog/admin/templates/pages/admin-forms-create.template'
...
adminFormsRoutes.get('/docs', async (c) => {
  try {
    const user = c.get('user')
    const { renderFormsDocsPage } = await import('@worker-blog/admin/templates/index.js')
...
adminFormsRoutes.get('/examples', async (c) => {
  try {
    const user = c.get('user')
    const { renderFormsExamplesPage } = await import('@worker-blog/admin/templates/index.js')
