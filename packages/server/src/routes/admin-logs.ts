...
import { renderLogsListPage, type LogsListPageData } from '@worker-blog/admin/templates/pages/admin-logs-list.template'
import { renderLogDetailsPage, type LogDetailsPageData } from '@worker-blog/admin/templates/pages/admin-log-details.template'
import { renderLogConfigPage, type LogConfigPageData } from '@worker-blog/admin/templates/pages/admin-log-config.template'
