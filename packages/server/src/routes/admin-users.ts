...
import { renderProfilePage, renderAvatarImage, type UserProfile, type ProfilePageData } from '@worker-blog/admin/templates/pages/admin-profile.template'
import { renderAlert } from '@worker-blog/admin/templates/components/alert.template'
import { renderActivityLogsPage, type ActivityLogsPageData, type ActivityLog } from '@worker-blog/admin/templates/pages/admin-activity-logs.template'
import { renderUserEditPage, type UserEditPageData, type UserEditData, type UserProfileData } from '@worker-blog/admin/templates/pages/admin-user-edit.template'
import { renderUserNewPage, type UserNewPageData } from '@worker-blog/admin/templates/pages/admin-user-new.template'
import { renderUsersListPage, type UsersListPageData, type User } from '@worker-blog/admin/templates/pages/admin-users-list.template'
