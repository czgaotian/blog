...
import type { TelemetryEvent, TelemetryProperties, TelemetryConfig, TelemetryIdentity } from '@worker-blog/shared/types/telemetry'
import { getTelemetryConfig } from '@worker-blog/shared/utils/telemetry-config'
import { generateInstallationId, generateProjectId, sanitizeErrorMessage, sanitizeRoute } from '@worker-blog/shared/utils/telemetry-id'
...
export class TelemetryService {
  ...
  async track(event: TelemetryEvent, properties?: TelemetryProperties): Promise<void> {
    ...
    try {
      ...
      // Send to custom Worker Blog stats endpoint
